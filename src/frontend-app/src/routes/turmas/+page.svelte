...
{:else if canView}
  <div class="text-center p-8 pt-32">
    <div class="flex items-center justify-between max-w-3xl mx-auto mb-6">
      ...
      <button class="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-semibold shadow transition" on:click={() => goto('/turmas/new')}>
        Adicionar
      </button>
    </div>
    <TurmasTable />
